...
# убрал логирование logging.info( f"Successfully initialized ClusterTreeBuilder with Config {config.log_config()}")
...
# убрал логирование  logging.info("Using Cluster TreeBuilder")
        ...
        for layer in range(self.num_layers):
            ...
            new_level_nodes = {}
# убрал логирование logging.info(f"Constructing Layer {layer}")

            node_list_current_layer = get_node_list(current_level_nodes)

            if len(node_list_current_layer) <= self.reduction_dimension + 1:
                self.num_layers = layer
# убрал логирование  logging.info( f"Stopping Layer construction: Cannot Create More Layers. Total Layers in tree: {layer}")
                break
...
# убрал логирование    logging.info(f"Summarization Length: {summarization_length}")
