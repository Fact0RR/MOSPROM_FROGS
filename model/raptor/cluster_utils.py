# TODO: здесь было логирование: import logging
import random
...
# убрал логирование (было в ифе)       logging.info(f"Global Clusters: {n_global_clusters}")
...
# убрал логирование(тоже в ифе)   logging.info(f"Nodes in Global Cluster {i}: {len(global_cluster_embeddings_)}")
...
# убрал логирование(тоже в ифе)      logging.info(f"Local Clusters in Global Cluster {i}: {n_local_clusters}")
...
# убрал логирование(тоже в ифе)   logging.info(f"Total Clusters: {total_clusters}")
...
# убрал логирование (опять в ифе)    logging.info(f"reclustering cluster with {len(cluster_nodes)} nodes")
