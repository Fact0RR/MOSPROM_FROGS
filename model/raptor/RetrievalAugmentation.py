...
class RetrievalAugmentation:
    ...
    def __init__(self, config=None, tree=None):
        ...
        if isinstance(tree, str):
            ...
            # убрал обработку except Exception 
        ...
        if self.tree is not None:
            ...
            self.retriever = None
# убрал логирование logging.info(f"Successfully initialized RetrievalAugmentation with Config {config.log_config()}")
...
# убрал логирование logging.info(f"Tree successfully saved to {path}")
