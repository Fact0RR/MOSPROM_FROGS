...
# убрал логирование logging.info(f"Successfully initialized TreeRetriever with Config {config.log_config()}")
    ...
    def retrieve(
        ...
        if collapse_tree:
# убрал логирование logging.info(f"Using collapsed_tree")
